...
from shell.model.equiformer_v2.components.so3 import SO3_Embedding
...
class EdgeDegreeEmbedding(torch.nn.Module):
    ...
    def forward(self, atomic_numbers, edge_distance, edge_index):
        if self.use_atom_edge_embedding:
            ...
            x_edge = edge_distance  # [num_edges, 512]

        x_edge_m_0 = self.rad_func(x_edge)   # here is the problem
